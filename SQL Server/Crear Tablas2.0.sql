...
CREATE TABLE TIPO_TABLERO_ESTADO(
	nombreTipo	VARCHAR(50) NOT NULL,
	nombreEstado	VARCHAR(50) NOT NULL,
	PRIMARY KEY(nombreTipo, nombreEstado)
);
...
ALTER TABLE TIPO_TABLERO_ESTADO
ADD FOREIGN KEY (nombreTipo) REFERENCES TIPO_TABLERO(nombre);